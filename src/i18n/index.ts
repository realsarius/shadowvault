...
const tr = {
  ...
  schedule_level0_label: "Full Yedek (Level 0) Zamanlaması",
  schedule_level0_desc: "Tüm dosyaların tam yedeğini ne sıklıkla alacağınızı belirleyin.",
  add_dest_max_sets: "Maksimum Yedek Seti",
  add_dest_max_sets_desc: "Saklanacak yedek seti sayısı (1 set = 1 Full + bağlı artımlı yedekler).",
  add_dest_level1_toggle: "Artımlı Yedeklemeyi Etkinleştir (Level 1)",
  add_dest_level1_desc: "Full yedekler arasında sadece değişen blokları yedekler. Depolama tasarrufu sağlar.",
  add_dest_level1_schedule: "Artımlı Yedek (Level 1) Zamanlaması",
  add_dest_level1_type: "Artımlı Yedek Tipi",
  add_dest_level1_cum_desc: "önerilen",
  add_dest_level1_diff_desc: "sadece son fark",
  ...
  vault_import_vault: "Kasa İçe Aktar",
  vault_export: "Dışa Aktar",
  vault_export_vault: "Kasayı Dışa Aktar",
  vault_export_success: "Kasa dışa aktarıldı: {path}",
  vault_import_success: "Kasa içe aktarıldı.",
  vault_import_invalid: "Seçilen klasör geçerli bir kasa yedeği değil.",
  ...
  vault_pw_mismatch: "Yeni şifreler eşleşmiyor.",
  vault_pw_empty: "Yeni şifre boş olamaz.",
  vault_pw_changed: "Şifre başarıyla değiştirildi.",
...
const en: Record<keyof typeof tr, string> = {
  ...
  schedule_level0_label: "Full Backup (Level 0) Schedule",
  schedule_level0_desc: "Set how often to take a complete backup of all files.",
  add_dest_max_sets: "Maximum Backup Sets",
  add_dest_max_sets_desc: "Number of backup sets to keep (1 set = 1 Full + related incremental backups).",
  add_dest_level1_toggle: "Enable Incremental Backup (Level 1)",
  add_dest_level1_desc: "Backs up only changed blocks between full backups. Saves storage space.",
  add_dest_level1_schedule: "Incremental Backup (Level 1) Schedule",
  add_dest_level1_type: "Incremental Backup Type",
  add_dest_level1_cum_desc: "recommended",
  add_dest_level1_diff_desc: "last diff only",
  ...
  vault_import_vault: "Import Vault",
  vault_export: "Export",
  vault_export_vault: "Export Vault",
  vault_export_success: "Vault exported: {path}",
  vault_import_success: "Vault imported.",
  vault_import_invalid: "Selected folder is not a valid vault backup.",
  vault_rename: "Rename",
  vault_move: "Move",
  vault_delete: "Delete",
  vault_open: "Open",
  ...
  vault_pw_mismatch: "New passwords do not match.",
  vault_pw_empty: "New password cannot be empty.",
  vault_pw_changed: "Password changed successfully.",
